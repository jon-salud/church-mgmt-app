  ...
  const mockUsers = [
    {
      ...
      roles: [{ role: 'member', roleId: 'role-member', churchId: 'church-1' }],
      groups: [{ id: 'group-1', name: 'Small Group', role: 'Member' }],
    ...
    },
    {
      ...
      roles: [{ role: 'leader', roleId: 'role-leader', churchId: 'church-1' }],
      groups: [
        { id: 'group-1', name: 'Small Group', role: 'Member' },
        { id: 'group-2', name: 'Worship Team', role: 'Leader' },
      ],
