...
export { mockRequestTypes, MockRequestType } from "./mock-data/request-type";
...
export type GroupType = "GeographicalMinistry" | "ServiceMinistry" | "VolunteerTeam" | "SmallGroup" | "Other";
...
export const mockRoles: MockRole[] = [
    {
        ...
        permissions: ["people.manage", "groups.manage", "events.manage", "announcements.manage", "giving.manage", "audit.read", "settings.manage"],
        isSystem: true,
        isDeletable: false,
