    ...
    return (
        <section className="space-y-8">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <StatCard label="Members" value={summary.memberCount} helper="Active in this church" testId="stat-members" />
                <StatCard label="Groups" value={summary.groupCount} helper="Across ministries" testId="stat-groups" />
                <StatCard label="Upcoming events" value={summary.upcomingEvents} helper="Next 30 days" testId="stat-events" />
                <StatCard label="Giving (30d)" value={`$${summary.totalGivingLast30.toFixed(2)}`} helper="Recorded manually" testId="stat-giving" />
            </div>
