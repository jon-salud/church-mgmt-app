    ...
    return (
        <section className="mx-auto max-w-md space-y-6 rounded-2xl border border-slate-800 bg-slate-950/80 p-6 shadow-xl shadow-slate-950/50">
            <header className="space-y-2 text-center">
                ...
                <p className="text-sm text-slate-400">Use Google or Facebook OAuth to receive a JWT session. First-time sign-ins are automatically provisioned as members.</p>
